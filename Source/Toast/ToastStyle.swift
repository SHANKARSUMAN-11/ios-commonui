...
public struct ToastStyle {
     ...
     */
    public var bottomSpaceToSuperView: CGFloat = 10.0
     ...
     */
    public var buttonFont: UIFont = .systemFont(ofSize: 16.0)
    ...
    /// Defines whether toast should be displayed full width or not
    public var shouldCoverFullWidth : Bool = false
