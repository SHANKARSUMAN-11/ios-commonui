...
class FloatingPanel: NSObject, UIGestureRecognizerDelegate, UIScrollViewDelegate {
    ...
    public var grabberAreaFrame: CGRect {
    ...
    @objc func handle(panGesture: UIPanGestureRecognizer) {
        ...
        case scrollView?.panGestureRecognizer:
            ...
            if surfaceView.isGrabberHit {
                viewcontroller.delegate?.floatingPanelDidDragGrabberHandle(viewcontroller, isSwipeDown: !(surfaceView.frame.minY >= layoutAdapter.topY))
            }
