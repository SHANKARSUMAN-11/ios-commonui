...
public protocol FloatingPanelControllerDelegate: class {
    ...
    func floatingPanelDidDragGrabberHandle(_ vc: FloatingPanelController, isSwipeDown: Bool)
}
...
public class FloatingPanelController: UIViewController, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    public var grabberFrame: CGRect {
        return floatingPanel.grabberAreaFrame
    }
    ...
    public var visualEffectView = UIVisualEffectView(effect: UIBlurEffect(style: .dark))
    ...
    public func setVibrancyAlpha(withValue alpha: CGFloat) {
    ...
    public func addPanel(toParent parent: UIViewController, belowView: UIView? = nil, animated: Bool = false, shouldPresentModally: Bool = false) {
