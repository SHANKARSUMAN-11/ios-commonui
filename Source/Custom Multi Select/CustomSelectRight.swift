//
//  CustomSelectRight.swift
//  CommonUIKit
//
//  Created by Rajadorai DS on 06/06/19.
//  Copyright © 2019 Coviam. All rights reserved.
//

import UIKit

public protocol CustomSelectRightDelegate: class {
    func didTapCustomSelect(sender: CustomSelectRight)
}

public extension CustomSelectRightDelegate {
    func didTapCustomSelect(sender: CustomSelectRight) {}
}

public class CustomSelectRight: UIView {
    ...
    public weak var delegate: CustomSelectRightDelegate? = nil
    ...
    public var horizontalAlignment: Position = .right {
        didSet {
            self.configurePosition()
        }
    }
    ...
    private func loadViewFromNib() {
        ...
        let nib = UINib(nibName: "CustomSelectRight", bundle: bundle)
